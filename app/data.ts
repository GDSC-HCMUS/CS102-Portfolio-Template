...
export const EMAIL = 'ngduong5124@gmail.com'
...
export const FOOTER_COPYRIGHT = '© 2025 Nguyen Van Binh Duong.'
export const FOOTER_LINK = 'https://github.com/'

export const NAME = 'Nguyen Van Binh Duong'
export const JOB_TITLE = 'CS Intern'
